 ...
 *
 * Identical USB setup to the app-first boot/ firmware: single peripheral,
 * USB1_OTG_HS running Full-Speed on its internal PHY (no external HS ULPI PHY on
 * the board).  TinyUSB maps roothub port 0 to it (see lib/tinyusb .../dwc2_stm32.h:
 * with USB2_OTG_FS undefined on H72x/H73x, rhport 0 aliases to OTG_HS base + IRQn).
 *
